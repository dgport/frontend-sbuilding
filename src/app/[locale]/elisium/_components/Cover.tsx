    ...
    <section className="h-auto w-full py-16 relative overflow-hidden">
      ...
      <div className="relative z-10">
                ...
                <CardContent className="flex items-center justify-center p-0">
                  <div className="relative group overflow-hidden rounded-lg shadow-2xl">
                    <Image
                      ...
                      height={540}
                      onClick={() => {
                        if (item.title === "Elisium Building") {
                          handleElisiumRedirect();
                        }
                      }}
                      style={{
                        cursor:
                          item.title === "Elisium Building"
                            ? "pointer"
                            : "default",
                      }}
                    />
        ...
        <div className="mt-12 text-center px-10">
          <div
            onClick={handleElisiumRedirect}
            className="cursor-pointer inline-flex items-center gap-3 bg-blue-500 from-blue-400 to-blue-600 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
          >
