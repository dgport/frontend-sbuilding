...
export function FloorSelector({
  ...
  // ✅ Mobile-to-LG version (horizontal scroll)
  if (isMobile) {
    return (
      <div className="xl:hidden bottom-0 left-0 right-0 z-20 px-3 pb-3 sm:px-4  sm:pb-4   xl:px-4 md:mt-2">
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-gray-200/70 py-5 px-3 sm:p-4">
          <div className="flex items-center gap-3 sm:gap-3">
            <button
              ...
              className="shrink-0 w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center bg-linear-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 rounded-xl transition-all shadow-md hover:shadow-xl active:scale-95"
            >
              ...
              <div className="floor-buttons-container flex gap-1.5 sm:gap-2 px-1">
                {floors.map((floor) => (
                  <button
                    ...
                    className={`shrink-0 min-w-10 min-h-10 my-2 sm:min-w-[50px] sm:h-11 px-2.5 rounded-md text-base sm:text-md font-bold transition-all shadow-md hover:shadow-xl active:scale-95 ${
                      currentFloor === floor
                        ? "bg-linear-to-br from-blue-600 via-blue-700 to-blue-800 text-white scale-105 shadow-blue-400/50 ring-2 ring-blue-400"
                        : "bg-linear-to-br from-gray-100 to-gray-200 text-gray-800 hover:from-blue-50 hover:to-blue-100 border-2 border-gray-300 hover:border-blue-300"
                    }`}
                  >
                    {floor}
                  </button>
